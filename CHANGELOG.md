...
- **弹窗玻璃可读性回归修复**: 全局下调全屏蒙版 blur，并把 Dialog / Popover / Toast / 浮动控件改为更实背景与轻量滤镜变量；随后略微加实承载文字的玻璃背景，同时保留 3px 轻磨砂效果。手动同步选择/冲突、欢迎弹窗、Token 提醒、阅读记录详情等共享确认弹窗统一使用 dialog 文本 token，避免背景论坛文字透进弹窗正文和同步对比表格。
