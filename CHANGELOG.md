...
- **修复UI元素跨平台对齐问题**: 修正了在不同操作系统（特别是 Windows）下，“同步数据”弹窗内徽章（例如“有更新”、“+5”）的垂直对齐问题。通过统一字体并改用 Flexbox 布局，确保了各类徽章在所有平台下都能精确对齐，提升了视觉一致性。
...
- **链接与跳转**：
  - 修复了“在新标签页打开”功能会错误地应用于帖子楼层内的“回复”、“编辑”按钮以及用户空间子导航栏的问题。
